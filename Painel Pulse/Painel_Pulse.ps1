                ...
                <Grid x:Name="Page_Restaurar" Visibility="Collapsed">
                    ...
                    <Border Grid.Row="1" Background="#1A1111" BorderBrush="#3D2020" BorderThickness="1" CornerRadius="8" Padding="12,8" Margin="0,0,0,16">
                        <StackPanel Orientation="Horizontal">
                            ...
                            <TextBlock Text="Como algumas foram desativadas na instalação do Windows, não há garantia de que voltará a funcionar." Foreground="#D68383" FontSize="12.5" VerticalAlignment="Center" FontWeight="SemiBold"/>
                        </StackPanel>
                    </Border>
