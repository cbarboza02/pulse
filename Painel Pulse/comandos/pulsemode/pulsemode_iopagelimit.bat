...
:padrao
:: Restaura o padrao do Windows: 0 = gerenciado automaticamente pelo sistema
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v IoPageLockLimit /t REG_DWORD /d 0 /f
exit

:gaming
:: Define o limite de paginas fixas de I/O em 128 MB (134217728 bytes)
:: Aumenta o buffer de memoria travada para operacoes de I/O, reduzindo latencia de disco
