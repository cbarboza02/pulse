...
:padrao
:: Restaura os valores padrao do Windows para filas de dados de mouse e teclado
:: MouseDataQueueSize padrao: 100 | KeyboardDataQueueSize padrao: 100
...
:equilibrado
:: Fila de mouse e teclado com 50 entradas
